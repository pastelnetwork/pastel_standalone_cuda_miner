...
public:
    CTestStratumClient() : 
        CStratumClient("localhost", 1234)
    {}

    void setBlockHeader(const CEquihashInput &blockHeader)
    {
        m_blockHeader = blockHeader;
    }

    const CEquihashInput& getBlockHeader() const noexcept
    {
...
{
public:
    CTestMiningThread(CStratumClient &StratumClient) : CMiningThread(StratumClient) {}

    uint256 generateNonce(const uint32_t nExtraNonce2) const noexcept
    {
        const auto stratumClient = dynamic_cast<const CTestStratumClient&>(m_StratumClient);
        return stratumClient.getBlockHeader().nNonce;
    }

    void submitSolution(const uint32_t nExtraNonce2, const string& sTime, 
    ...
    {
        return CMiningThread::miningLoop(initialState, nExtraNonce2, sTime, nIterations, threadsPerBlock);
    }
...
/*
   

*/
    ...
    stratumClient.setBlockHeader(blockHeader);

    // Initialize initialState with the desired values
    CDataStream ss(SER_NETWORK, PROTOCOL_VERSION);
    ss << blockHeader;
    v_uint8 vEquihashInput;
    vEquihashInput.resize(ss.size());
    ss.read_buf(vEquihashInput.data(), ss.size());
    cout << "equihash input: " << HexStr(vEquihashInput) << endl;

    blake2b_update_host(&state, (unsigned char*)&ss[0], ss.size());

    blake2b_state stateTest = state;
    blake2b_update_host(&stateTest, blockHeader.nNonce.begin(), blockHeader.nNonce.size());
    // // existing solution:
    ...
    // v_uint32 vIndices = GetIndicesFromMinimal(vSolution, eh.CollisionBitLength);
    // string s;
    // for (auto i : vIndices)
    //     s += to_string(i) + " ";
    // cout << "indices: " << s << endl;
    // string sError;
    // if (!eh.IsValidSolution(sError, stateTest, vSolution))
    // {
    ...
    CTestMiningThread miningThread(stratumClient);

    // Call the miningLoop function
    uint32_t solutionCount = miningThread.miningLoop(state, nExtraNonce2, sTime, nIterations, threadsPerBlock);
